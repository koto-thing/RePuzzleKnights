...
namespace RePuzzleKnights.Scripts.Infrastructure.InGame.PathFinder
{
    public class GraphCreator : MonoBehaviour
    {
        ...
        public Graph CreatedGraph => _graph;
        ...
        public List<string> AllBlockNames { get; private set; } = new List<string>();
        ...
        private void SetupEdges()
        {
            ...
            foreach (var blockObj in blockGameObjects)
            {
                ...
                var block = _graph.GetBlock(blockObj.name);
            ...
            for (int i = 0; i < blocksInGraph.Count; i++)
            {
                ...
                for (int j = i + 1; j < blocksInGraph.Count; j++)
                {
                    ...
                    {
                        _graph.AddEdge(blockA.Name, blockB.Name, 1);
                    }
                }
            }
        }
